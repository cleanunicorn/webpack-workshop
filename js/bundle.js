...
/***/ function(module, exports, __webpack_require__) {
	...
	$ = jQuery = __webpack_require__(159);
	React = __webpack_require__(2);
	ReactDOM = __webpack_require__(160);
	LoginForm = __webpack_require__(1);
	...
	var LoginForm = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            'form',
	            { action: '/', method: 'post', onSubmit: this.handleLogin },
	            React.createElement(
	                'div',
	                { className: 'form-group' },
	                React.createElement('input', { type: 'text', className: 'form-control', name: 'email', onChange: this.handleEmailChange, value: this.state.email })
	            ),
	            React.createElement(
	                'div',
	                { className: 'form-group' },
	                React.createElement('input', { type: 'password', className: 'form-control', name: 'password', onChange: this.handlePasswordChange, value: this.state.password })
	            ),
	            React.createElement(
	                'div',
	                { className: 'form-group' },
	                React.createElement('input', { type: 'submit', className: 'btn btn-default', value: 'Login' })
	            )
	        );
	    }
	});
